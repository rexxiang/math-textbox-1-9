...
\end{tikzpicture}
\captionof{figure}{直角坐标系：点 $P(x,y)$ 由横坐标 $x$ 和纵坐标 $y$ 唯一确定}
...
\begin{enumerate}
  \item 点 $M(-5, 2)$ 关于 $x$ 轴的对称点是\underline{\hspace{2cm}}，关于 $y$ 轴的对称点是\underline{\hspace{2cm}}，关于原点的对称点是\underline{\hspace{2cm}}。
...
\end{tikzpicture}
\captionof{figure}{两点间距离公式：$|AB| = \sqrt{(x_2-x_1)^2+(y_2-y_1)^2}$}
