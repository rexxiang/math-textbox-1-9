...
\end{tikzpicture}
\caption{圆的基本元素：圆心 $O$，半径 $r$，直径，弦，弧}
...
\end{tikzpicture}
\caption{垂径定理：$OM \perp AB \Rightarrow AM = MB$（过圆心的垂线平分弦）}
...
\end{tikzpicture}
\caption{圆心角是圆周角的 2 倍：$\angle AOB = 2\,\angle APB$（同弧 $\widehat{AB}$ 上）}
