...
验证：频次之和 $= 200$ $\checkmark$，频率之和 $= 1.00$ $\checkmark$。
...
验证：所有矩形面积之和 $= 0.175 + 0.200 + 0.200 + 0.200 + 0.125 + 0.100 = 1.00$ $\checkmark$
...
\end{axis}
\end{tikzpicture}
\captionof{figure}{百米跑成绩频率分布直方图（组距 $= 0.5$ 秒）}
...
\end{axis}
\end{tikzpicture}
\captionof{figure}{某次考试成绩频率分布直方图（组距 $= 10$ 分，$n=50$）}
...
先验证数据：所有频率之和 $= (0.004 + 0.012 + 0.020 + 0.036 + 0.024 + 0.004) \times 10 = 0.100 \times 10 = 1.00$ $\checkmark$
