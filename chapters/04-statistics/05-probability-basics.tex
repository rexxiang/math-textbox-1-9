...
验证： $\frac{2}{5} + \frac{3}{5} = 1$ $\checkmark$（摸出的球要么是红球要么是白球。）
...
\begin{tikzpicture}[
  ...
  grow=right, edge from parent/.style={draw,-}
]
\node {起点}
  child { node {白衣}
    child { node {(白,卡其)} edge from parent node[above,font=\scriptsize]{卡其裤} }
    child { node {(白,灰)} edge from parent node[above,font=\scriptsize]{灰裤} }
    child { node {(白,黑)} edge from parent node[above,font=\scriptsize]{黑裤} }
    edge from parent node[above,font=\scriptsize]{白衣}
  }
  child { node {蓝衣}
    child { node {(蓝,卡其)} edge from parent node[above,font=\scriptsize]{卡其裤} }
    child { node {(蓝,灰)} edge from parent node[above,font=\scriptsize]{灰裤} }
    child { node {(蓝,黑)} edge from parent node[above,font=\scriptsize]{黑裤} }
    edge from parent node[above,font=\scriptsize]{蓝衣}
  };
\end{tikzpicture}
\end{center}
...
\node {起点}
  child { node {甲}
    child { node {(甲,丙)} edge from parent node[above,font=\scriptsize]{丙} }
    child { node {(甲,乙)} edge from parent node[above,font=\scriptsize]{乙} }
    edge from parent node[above,font=\scriptsize]{甲}
  }
  child { node {乙}
    child { node {(乙,丙)} edge from parent node[above,font=\scriptsize]{丙} }
    child { node {(乙,甲)} edge from parent node[above,font=\scriptsize]{甲} }
    edge from parent node[above,font=\scriptsize]{乙}
  }
  child { node {丙}
    child { node {(丙,乙)} edge from parent node[above,font=\scriptsize]{乙} }
    child { node {(丙,甲)} edge from parent node[above,font=\scriptsize]{甲} }
    edge from parent node[above,font=\scriptsize]{丙}
  };
\end{tikzpicture}
\end{center}
...
\node {起点}
  child { node {红$_1$}
    child { node {黄$_2$\quad(红$_1$,黄$_2$)} edge from parent node[above,font=\scriptsize]{黄$_2$} }
    child { node {白$_2$\quad(红$_1$,白$_2$)} edge from parent node[above,font=\scriptsize]{白$_2$} }
    child { node {红$_2$\quad(红$_1$,红$_2$)\,$\checkmark$} edge from parent node[above,font=\scriptsize]{红$_2$} }
    edge from parent node[above,font=\scriptsize]{红$_1$}
  }
  child { node {白$_1$}
    child { node {黄$_2$\quad(白$_1$,黄$_2$)} edge from parent node[above,font=\scriptsize]{黄$_2$} }
    child { node {白$_2$\quad(白$_1$,白$_2$)\,$\checkmark$} edge from parent node[above,font=\scriptsize]{白$_2$} }
    child { node {红$_2$\quad(白$_1$,红$_2$)} edge from parent node[above,font=\scriptsize]{红$_2$} }
    edge from parent node[above,font=\scriptsize]{白$_1$}
  };
\end{tikzpicture}
\end{center}
...
颜色相同的结果：$(红_1,红_2)$ 和 $(白_1,白_2)$，共 $2$ 种。
...
第 1 次 \ 第 2 次 & 1 & 2 & 3 \\
\midrule
\textbf{1} & (1,1) $\checkmark$ & (1,2) & (1,3) \\
\textbf{2} & (2,1) & (2,2) $\checkmark$ & (2,3) \\
\textbf{3} & (3,1) & (3,2) & (3,3) $\checkmark$ \\
\bottomrule
\end{tabular}
\end{center}
...
\node {起点}
  child { node {1}
    child { node {(1,3) 偶} edge from parent node[above,font=\scriptsize]{3} }
    child { node {(1,2) 奇\,$\checkmark$} edge from parent node[above,font=\scriptsize]{2} }
    edge from parent node[above,font=\scriptsize]{1}
  }
  child { node {2}
    child { node {(2,3) 奇\,$\checkmark$} edge from parent node[above,font=\scriptsize]{3} }
    child { node {(2,1) 奇\,$\checkmark$} edge from parent node[above,font=\scriptsize]{1} }
    edge from parent node[above,font=\scriptsize]{2}
  }
  child { node {3}
    child { node {(3,2) 奇\,$\checkmark$} edge from parent node[above,font=\scriptsize]{2} }
    child { node {(3,1) 偶} edge from parent node[above,font=\scriptsize]{1} }
    edge from parent node[above,font=\scriptsize]{3}
  };
\end{tikzpicture}
\end{center}
...
\node {起点}
  child { node {A}
    child { node {(A,Q)} edge from parent node[above,font=\scriptsize]{Q} }
    child { node {(A,P)} edge from parent node[above,font=\scriptsize]{P} }
    edge from parent node[above,font=\scriptsize]{A}
  }
  child { node {B}
    child { node {(B,Q)} edge from parent node[above,font=\scriptsize]{Q} }
    child { node {(B,P)} edge from parent node[above,font=\scriptsize]{P} }
    edge from parent node[above,font=\scriptsize]{B}
  }
  child { node {C}
    child { node {(C,Q)} edge from parent node[above,font=\scriptsize]{Q} }
    child { node {(C,P)} edge from parent node[above,font=\scriptsize]{P} }
    edge from parent node[above,font=\scriptsize]{C}
  };
\end{tikzpicture}
\end{center}
...
验证： $\frac{5}{12} + \frac{5}{12} + \frac{1}{6} = \frac{5}{12} + \frac{5}{12} + \frac{2}{12} = 1$ $\checkmark$
...
\node {起点}
  child { node {红$_1$}
    child { node {(红$_1$,蓝)} edge from parent node[above,font=\scriptsize]{蓝} }
    child { node {(红$_1$,红$_2$)} edge from parent node[above,font=\scriptsize]{红$_2$} }
    edge from parent node[above,font=\scriptsize]{红$_1$}
  }
  child { node {红$_2$}
    child { node {(红$_2$,蓝)} edge from parent node[above,font=\scriptsize]{蓝} }
    child { node {(红$_2$,红$_1$)} edge from parent node[above,font=\scriptsize]{红$_1$} }
    edge from parent node[above,font=\scriptsize]{红$_2$}
  }
  child { node {蓝}
    child { node {(蓝,红$_2$)} edge from parent node[above,font=\scriptsize]{红$_2$} }
    child { node {(蓝,红$_1$)} edge from parent node[above,font=\scriptsize]{红$_1$} }
    edge from parent node[above,font=\scriptsize]{蓝}
  };
\end{tikzpicture}
\end{center}
