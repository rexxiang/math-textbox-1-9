...
\begin{itemize}
  \item 代入第一个方程： $2 + 3 = 5$ $\checkmark$
  \item 代入第二个方程： $45 \times 2 + 30 \times 3 = 90 + 90 = 180$ $\checkmark$
\end{itemize}
...
\textbf{解：} 例如 $\begin{cases} x + y = 3 \\ 2x - y = 0 \end{cases}$ 。验证： $1 + 2 = 3$ $\checkmark$， $2 \times 1 - 2 = 0$ $\checkmark$。
...
\begin{enumerate}
  \item $3 - 2 = 1$ $\checkmark$， $2 \times 3 + 2 = 8$ $\checkmark$。是解。
