...
#history-note[
  高斯 10 岁时，老师让全班算 $1 + 2 + 3 + dots.h + 100$。高斯几秒钟就给出了答案 $5050$——他发现首尾配对：$1 + 100 = 2 + 99 = dots.h = 101$，共 50 对，$50 times 101 = 5050$。这正是交换律的极致运用：通过重新排列加数，把难题变成了简单的乘法。
]
...
#tryit[
  *先自己试试*：用凑整法快速计算 $125 times 37 times 8$。

  提示：$125 times 8$ 是一个整千数。想想能不能先改变计算顺序。
  写下你的思路，再往下对照运算律。
]
