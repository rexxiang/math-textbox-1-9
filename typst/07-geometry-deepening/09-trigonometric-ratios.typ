...
#crisis[
  你已经会用 #secref("7.8") 在直角三角形里处理三条边的关系。可要是现在只给你一个锐角，再给你一条边，另两条边之间有没有一条更直接的“比例密码”？
...
#discovery[
  *第一步：角相同的直角三角形，其实只是彼此放大或缩小。*
  ...
  回看 #secref("7.4")：若两个直角三角形有同一个锐角，那么它们彼此相似。所以虽然大小不同，但对应边会按同一个倍数变化。
...
#tryit[
  ...
  + 把“对边和斜边的比”写出来。
  + 若先用 #secref("7.8") 求出邻边，再把“邻边和斜边的比”“对边和邻边的比”写出来。
]
...
#mastery[
  ...
  *挑战*
  ...
  + 解释为什么本节必须建立在 #secref("7.4") 的相似思想上。
