...
#mastery[
  ...
  *挑战*
  ...
  + *挑战*：圆内接四边形 $ABCD$，已知 $AB$ 是直径，$AC = 3$，$BC = 4$。
    - 先说明 $angle ACB = 90°$（为什么？联系直径对应的圆周角）
    - 求斜边 $AB$（用勾股定理，#secref(“7.8”)）
    - 如果还知道 $AD = 5$，$angle DAB = 90°$，求 $DB$
  ...
  *挑战*
  ...
  + 挑战答案：$AB$ 是直径，所以圆周角 $angle ACB = 90°$（直径所对圆周角是直角，§7.6）。$AB = sqrt(AC^2 + BC^2) = sqrt(9 + 16) = 5$。$angle DAB = 90°$（已知），$DB = sqrt(AD^2 + AB^2) = sqrt(25 + 25) = 5sqrt(2)$。
