...
#blueprint[
  *几何支最容易出现的 $10$ 类误读*
  ...
  #table(
    ...
    [对非特殊角硬写 $sin$、$cos$、$tan$ 的精确值], [本支“特殊角”约束没守住], [#secref("ge04-special-right-triangles")],
...
#side-hack[
  *本支与其它分支的接口*
  ...
  - 往函数去：直线 $y = k x + b$ 的*斜率* $k$ 就是直角三角形里的 $tan$；图象的平移 / 反射就是本支的刚体变换。
  - 往数据去：散点图的两点距离、重心位置要用本支的坐标公式；几何题里的“分布”“平均”给数据支提供直观来源。
]
