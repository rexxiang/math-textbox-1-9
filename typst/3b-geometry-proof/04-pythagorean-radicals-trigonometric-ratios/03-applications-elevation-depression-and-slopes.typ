...
#history-note[
  中国古代的《九章算术》里有“勾股术”专章，其实就是今天的测高测远问题：在地上量一段，仰头测一个角，就能得到塔、山、河对岸建筑的高度或距离。这是数学第一次成为“可以帮人看到自己看不到的地方”的工具。
]
...
#tryit[
  ...
  + 一条坡度为 $1 : sqrt(3)$ 的斜坡。它的坡角 $beta$ 是多少？
]
...
#mastery[
  ...
  *基础*
  + 塔高 $= 20 tan 45 degree = 20$ 米。
  + 铅直距离 $= 10 tan 60 degree = 10 sqrt(3)$ 米。
  + 坡度 $1 : 1 =>$ $tan beta = 1 =>$ $beta = 45 degree$。
