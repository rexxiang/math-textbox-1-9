...
#mastery[
  *练一练*
  ...
  + *挑战 1*：20 米篱笆围成长方形菜地。试列出几组可能的长和宽（如 1 和 9、2 和 8、3 和 7……），比较它们的面积。你发现哪一种围法面积最大？

  + *挑战 2*：平面上有 5 个点（没有三点共线），把每两个点连成线段，一共可以画多少条？如果换成 6 个点呢？试着说说你看到的规律。
  ...
  + 可能的整数长宽有：1 和 9、2 和 8、3 和 7、4 和 6、5 和 5。对应面积分别是 9、16、21、24、25。可以看出围成正方形时面积最大。

  + 5 个点可以画 10 条线段；6 个点可以画 15 条。规律是：每多 1 个点，就会多出它和前面所有点之间的新线段。
]
