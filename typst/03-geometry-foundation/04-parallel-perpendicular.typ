...
#figure(
  ...
  *第四步*：内错角——"夹在两线之间、分居两侧"的角。
  ...
  直觉告诉我们：如果两条轨道平行，截线的"倾斜角度"在每个交点都是一样的——所以同位角相等，内错角也相等。
]
...
#pitfall[
  *陷阱 1*：没有确认两线平行就直接用角关系。

  同位角相等、内错角相等，都以"两线平行"为前提。先看题目有没有告诉你 $a parallel b$。

  *陷阱 2*：把同位角和内错角搞混。

  同位角在截线*同一侧*（都在右边，或都在左边）；内错角在截线*两侧*，且夹在平行线之间。
]
