...
== 回补路径手册 <tool:cp02-repair-route-playbook>

卡住是*正常*的。问题不是“卡了”，而是“卡住之后*下一步到底做什么*”。本节给出 6 条典型的回补样板线——凡遇到类似症状，照着线头回补即可。

#blueprint[
  *通用回补流程*（三问法）

  + 我*当前*在用哪个工具？它在哪节安装？
  + 这个工具*依赖*哪个更底层的旧工具？（看它发明时“需要先会的旧工具”列的第一项。）
  + 那个旧工具我*现在*能当场默写一遍吗？不能就回那一节，5–10 分钟复读 + 1 道小题，再回来接原题。
