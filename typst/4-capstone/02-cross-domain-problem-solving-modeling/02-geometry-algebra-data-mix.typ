...
#blueprint[
  ...
  *使用知识链*：#secref("fn11-model-choice") $->$ #secref("fn05-linear-function") $->$ #secref("al05-linear-inequalities") $->$ #secref("dt02-charts-and-readings")。
]
...
#blueprint[
  ...
  *使用知识链*：#secref("dt09-experimental-frequency") $->$ #secref("dt08-probability-language") $->$ #secref("pf04-fraction-arithmetic")。
]
