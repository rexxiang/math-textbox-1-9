...
#discovery[
  *先用旧工具试试。* 面积 $2$ 的正方形边长是多少？用小数逼近：$1.4^2 = 1.96$，差了 $0.04$；$1.41^2 = 1.9881$，差了 $0.0119$；$1.414^2 = 1.999396$，差了不到 $0.001$。再精确一点就够了？

  试着推下去——

  $1.4142^2 = 1.99997164$，$1.41421^2 = 1.9999897...$，$1.414213^2 = 1.999998409...$——每次都"接近" $2$，但永远差一丁点，没有任何有限小数能平方恰好等于 $2$。

  *这里卡住了。* 有限小数的平方只能趋近 $2$，无法精确等于 $2$；而"写出更多位"是永无止境的追逐。我们没有任何现有记号能*精确指代*"哪个正数的平方等于 $2$"这件事，需要一种新的符号来直接命名它。
