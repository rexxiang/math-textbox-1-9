...
#history-note[
  古巴比伦的 YBC 7289 泥板（约前 $1800$—$1600$ 年）用六十进制刻下了 $sqrt(2)$ 的近似值；换算成十进制后精度相当于约 $5$ 位小数。巴比伦人发明了一种反复取平均的逼近算法来求平方根，后人称之为"巴比伦方法"。在中国，南北朝的祖冲之（$429$—$500$ 年）也精通开方术，他算出的圆周率精度领先世界近千年。古希腊几何学家则把"求一条边，使其平方等于给定面积"视为核心操作——平方根就是这条操作的代数名字。
