...
#discovery[
  *先用旧工具试试。* 也许平方等于 $2$ 的数等于某个我们还没找到的分数？逐步逼近：$3 / 2 = 1.5$，$(3 / 2)^2 = 2.25$，偏大；$7 / 5 = 1.4$，$(7 / 5)^2 = 49 / 25 = 1.96$，偏小；$17 / 12 approx 1.4167$，$(17 / 12)^2 = 289 / 144 approx 2.0069$，差一点点；$41 / 29 approx 1.4138$，$(41 / 29)^2 approx 1.99881$。
  ...
  *这里卡住了。* 单纯"试更多分数"只能得到近似值，永远无法证明存在精确的分数解，也无法证明不存在——它是"还没找到"还是"永远找不到"？我们需要一种能*一次性排除所有分数可能性*的论证办法。
