...
#tryit[
  + 写出一个比 $-3$ 更靠左的数。
  + 写出一个比 $-1$ 更靠右、但仍在 $0$ 左边的数。
  + 写出一个比 $-3$ 大、但比 $-2$ 小的小数。

  ☞ 提示：先在脑中画出 $-3, -2, -1, 0$ 的位置；数轴上越往右越大，"仍在 $0$ 左边"就是还要保持负号。

  #answer-cut[
    + *答*：例如 $-4$。*做法*：比 $-3$ 更靠左，就是比 $-3$ 更小。*验证*：数轴上 $-4$ 在 $-3$ 左边，所以 $-4 < -3$。
    + *答*：例如 $-0.5$。*做法*：它在 $-1$ 与 $0$ 之间，既比 $-1$ 靠右，又没有越过 $0$。*验证*：$-1 < -0.5 < 0$。
    + *答*：例如 $-2.5$。*做法*：它夹在 $-3$ 和 $-2$ 中间。*验证*：$-3 < -2.5 < -2$。
  ]
]
...
#tryit[
  ...
  *提示*：不要先比“离 $0$ 远近”；先在数轴上想谁更靠右。两个负小数可以先写成同位小数：$-0.30$ 与 $-0.03$。

  #answer-cut[
    + *答*：$-2 > -5$；$-0.03 > -0.3$。*做法*：数轴上右边更大，$-2$ 在 $-5$ 右边；$-0.03$ 比 $-0.30$ 更接近 $0$，也更靠右。*验证*：两组都符合“右大左小”。
  ]
]
...
#pitfall[
  *高频错误*
  ...
  ✗ 把 $0$ 当成负数
  → ✓ $0$ 是分界点，既不是正数也不是负数；没有正负号，不代表它属于负数。
]
