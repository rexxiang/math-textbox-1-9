...
#blueprint[
  *难度*：★★★★☆ \
  *核心问题*：从“*一张杂乱的数字表*”到“*从部分估计整体*”——这条数据分支发明链的骨架是什么？拿到任意一个“面对一堆数据该怎么办”的问题，你心里应该立刻浮现哪几种工具、哪一套流程？如果中途某处卡住，该回哪一章？ \
  ...
  *本章在全书的位置*：数据分支*收束*——它不发明新工具，而是把全支的 $12$ 个工具串起来看清“*描述 $->$ 压缩 $->$ 不确定 $->$ 推断*”这条主线。 \
...
#side-hack[
  ...
  *这章通向哪里*
  ...
  - 高中：抽样分布、正态分布、置信区间、假设检验、相关与回归——都是本支的延续。
]
