...
如果把整本书看成一次发明旅程，那么终章最重要的工作，就是把“先学这个、再学那个”的记忆，改写成“这些工具为什么会从同一条主干长出来”的理解。
...
#table(
  ...
  [数据统计], [9], [把收集、整理、代表值、波动、概率和样本估计接成完整判断链。],
  [终章综合], [10], [回看整棵树如何互相支撑，并把“我是发明者”这件事带向书外。],
)
...
- *几何深化*：在 #secref("7.1") 到 #secref("7.8") 里，你把“看起来对”推进成“必须如此”，又把测量问题接到相似、勾股与三角比上；这里的三角比在 #secref("7.6")，属于测量链，而不是函数分支里的旧挂件。
