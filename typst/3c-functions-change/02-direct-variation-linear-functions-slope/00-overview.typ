...
#blueprint[
  ...
  *需要先会*：#secref("cb01-ratio-basics")、#secref("cb01-proportion")（比与比例）、#secref("cb03-rectangular-system")（坐标平面）、#secref("cb04-expressions-and-like-terms")（代数式）、#secref("cb05-solving-linear")（一次方程）、#secref("ge02-similarity-aa-ratio")（相似支撑“斜率与选点无关”）、#secref("fn03-formula-as-function-view")（函数公式与定义域）。 \
