...
#mastery[
  ...
  *参考答案*
  ...
  + 七个点：$(-3, 5), (-2, 0), (-1, -3), (0, -4), (1, -3), (2, 0), (3, 5)$。描点连线得开口向上的抛物线。任一条铅垂线至多交曲线一次——*通过*垂线检验，是函数。 // 工具：代入求值 + 描点法（#secref("cb04-rectangular-system")） // 跨章回顾
  + 定义域 ${x | x != 3}$（分母非零）。解 $frac(2 x + 1, x - 3) = 5$：两边乘 $(x - 3)$ 得 $2 x + 1 = 5 x - 15$，$16 = 3 x$，$x = 16 / 3$。检验 $x != 3$ ✓。 // 工具：等式性质（#secref("cb06-equality-properties")）+ 分母非零 // 跨章回顾
