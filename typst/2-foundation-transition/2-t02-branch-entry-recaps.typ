...
#blueprint[
  *四条分支的入口钥匙*
  ...
  入口回看只做一件事：*先想起前面学过的知识*。这里不提前讲新分支内容，只确认你手边的地基是不是已经拿顺手。
]
