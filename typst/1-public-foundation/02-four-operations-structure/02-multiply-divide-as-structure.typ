...
#discovery[
  *先用旧工具试试。* 我们只有加法——"6 把椅子摆 5 排"写成 $6 + 6 + 6 + 6 + 6 = 30$，没问题。现在换成"6 把椅子摆 25 排"：把 6 写 25 次相加……
  ...
  *这里卡住了。* 加法把每一个 6 都单独列出来，无法把"同样大小的小组反复出现"这个结构直接打包——我们需要一种能把"几组""每组多少"分开写、让重复结构一眼可见的新写法。
