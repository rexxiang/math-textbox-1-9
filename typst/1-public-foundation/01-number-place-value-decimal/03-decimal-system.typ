...
#mastery[
  ...
  *挑战 ☞ 选做*
  ...
  + *估算 / 量级题*：一张 A4 纸厚约 $0.1$ 毫米（$= 0.0001$ 米）。如果把 $10000$ 张 A4 纸叠在一起，高度是多少米？如果叠 $1000000$ 张（$100$ 万张），高度超过 $100$ 米吗？写出你的估算过程。
  ...
  + $10000$ 张 $= 10000 times 0.0001 = 1$ 米；$1000000$ 张 $= 1000000 times 0.0001 = 100$ 米（等于一栋约 $30$ 层的楼高）。恰好是 $100$ 米。
  ]
]
