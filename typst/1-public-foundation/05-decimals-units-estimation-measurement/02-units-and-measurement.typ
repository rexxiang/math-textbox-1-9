...
#tryit[
  ...
  *提示*：先写出 $1 "米" = 100 "厘米"$；从米到厘米，是把大单位换成更小的厘米单位。

  #answer-cut[
    + *答*：$230 "厘米"$。*做法*：$2.3 "米" = 2.3 times 100 "厘米" = 230 "厘米"$。*验证*：厘米比米小，换成厘米后数值应变大。
  ]
]
...
#tryit[
  ...
  *提示*：先把 $100 "厘米" = 1 "米"$ 放在旁边；厘米换米，数值要除以 $100$。

  #answer-cut[
    + *答*：$3.5 "米"$。*做法*：$350 "厘米" = 350 div 100 "米" = 3.5 "米"$。*验证*：米比厘米大，换成米后数值应变小。
  ]
]
...
#history-note[
  *玛丽·萨默维尔（Mary Somerville，$1780$–$1872$）*——苏格兰数学家与科学普及家。她的代表作《天体力学》$(1831)$ 把法国数学家拉普拉斯（Laplace）那部令人望而生畏的天文学巨著翻译并重写成英语读者能读懂的版本，里面充满了单位换算、量纲分析与数量级估算——天文距离用光年还是用千米、行星质量用什么单位最方便比较，她都耐心交代。这本书直到 $19$ 世纪后期还在剑桥大学当作教材用。萨默维尔是史上最早被英国皇家天文学会接纳的两位女性之一，今天牛津大学的萨默维尔学院就以她命名。
]
