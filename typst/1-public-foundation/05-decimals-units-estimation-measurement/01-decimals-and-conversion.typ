...
#discovery[
  ...
  再试 $0.625$：三位小数，分母猜 $1000$，写成 $625/1000$，化简得 $1/8$。

  反过来，把 $1/3$ 转成小数呢？$1 div 3 = 0.333dots$，永远算不完。这就奇怪了——分数和小数是同一个量吗？

  如果是同一个量，为什么有的分数能化成有限小数，有的却不能？每次都靠猜，没有清晰规律。
