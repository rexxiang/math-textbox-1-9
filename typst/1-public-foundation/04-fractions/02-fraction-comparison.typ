...
#side-hack[
  *完整示例*——比较 $2/3$ 与 $3/5$
  ...
  + *看题*：两个分数的分母不同，直接比 $2$ 和 $3$ 会把"每份大小"混掉。
  + *选工具*：用本节工具"统一尺子"：把三等分和五等分都改成十五等分。
  + *动手*：$2/3 = 10/15$，$3/5 = 9/15$。同分母时比分子，$10 > 9$，所以 $2/3 > 3/5$。
  + *回看*：画成 $15$ 个小格也一样：$2/3$ 占 $10$ 格，$3/5$ 占 $9$ 格，前者多一格。
]
...
#mastery[
  ...
  *挑战*
  ...
  + 法则不总成立。提示：考虑分母不同号（含负分母）的情形，看不等号方向是否会反过来。
  ]
]
