...
#history-note[
  $<$ 与 $>$ 这两个符号最早出现在英国数学家、探险家托马斯·哈里奥特（Thomas Harriot, 1560–1621）去世后由友人整理出版的《实践分析术》（_Artis Analyticae Praxis_, 1631）中。哈里奥特本人曾随沃尔特·雷利远征北美，他在数学上的创新同样大胆：用尖角的开口方向来表示大小关系，直观且简洁。$<=$ 与 $>=$ 的现代印刷形式则在 17 世纪末至 18 世纪间逐步固定。在此之前，不等关系通常只能用文字"大于""小于"来表述——符号的引入让不等式终于可以像等式一样被书写和运算。
]
...
#mastery[
  ...
  *应用*
  ...
  + 解 $|2 x - 1| < 5$。
  + 解 $|x + 3| >= 4$。
  + Yusuf四次数学测验分别考了 $85, 90, 78, 92$。第 $5$ 次至少考多少分，才能使 $5$ 次平均分不低于 $85$？
