...
#side-hack[
  *入章自检*——以下几道小题只用前面章节学过的知识。如果卡住，请先回到上面"需要先会"的链接补一补。
  ...
  + 小明今年 $a$ 岁。$5$ 年后他多大？$3$ 年前他多大？爸爸今年比小明大 $30$ 岁，*$5$ 年后*爸爸的年龄如何用 $a$ 表达？
  + 把下面三句话*分别*翻译成代数式（设那个数为 $x$）：①"比 $x$ 多 $7$"；②"$x$ 的 $3$ 倍少 $7$"；③"$x$ 与 $7$ 的差的 $3$ 倍"。提醒：②和③不一样。
  + 解方程 $3 (x - 4) = 9$。请写出每一步*用了哪条等式性质*——而不仅仅是"两边除以 $3$"。
]
