...
#history-note[
  法国数学家韦达（François Viète，1540–1603）把“系数”和“根”的关系写成了第一批明确的代数公式之一，这也是“代数”从“解题技巧”升格为“一般理论”的一个重要节点。
]
...
#tryit[
  ...
  + 判断 $2 x^2 - 3 x + 4 = 0$ 是否有实根；若有，是同正、同负还是一正一负？
]
...
#mastery[
  ...
  *基础*
  + $5, 6$；$- 3/2, - 1/2$；$- 7, 10$。
  + $x_1 + x_2 = 4$，$x_1 x_2 = 1$。$x_1^2 + x_2^2 = 16 - 2 = 14$；$1 / x_1 + 1 / x_2 = 4 / 1 = 4$。
