...
#mastery[
  *基础*
  ...
  + 正用公式展开：
    ...
    - $(3 a + 5 b)^2$
    - $(x^2 - 1)^2$
  + *识别题*——下面四个式子里，哪些可以用平方差或完全平方公式直接因式分解？哪些不能？给出判定理由（首末是否各为某个量的平方？中间项是否等于"两个量乘积的 $2$ 倍"？正负号对得上吗？）：
    - $x^2 + 9$
    - $4 a^2 - 25$
    - $y^2 + 8 y + 16$
    - $9 m^2 - 30 m + 16$
  + *补全题*——把下面每个空填上，使等式成立（注意：可能不止一种填法）：
    - $x^2 + 12 x + #h(0.4em) square #h(0.4em) = (x + #h(0.4em) square #h(0.4em))^2$
    - $4 y^2 - #h(0.4em) square #h(0.4em) y + 9 = (2 y - 3)^2$
    - $#h(0.4em) square #h(0.4em) - 49 b^2 = (#h(0.4em) square #h(0.4em) + 7 b)(#h(0.4em) square #h(0.4em) - 7 b)$
  ...
  *基础*
  ...
  + 识别题：$x^2 + 9$ 是两平方之*和*，实数范围内*不能*分解；$4 a^2 - 25 = (2 a)^2 - 5^2$ 是平方差，$= (2 a + 5)(2 a - 5)$；$y^2 + 8 y + 16$ 首末为 $y^2, 4^2$，中间 $8 y = 2 dot y dot 4$ ✓，是完全平方 $= (y + 4)^2$；$9 m^2 - 30 m + 16$ 首末为 $(3 m)^2, 4^2$，但中间 $2 dot 3 m dot 4 = 24 m != 30 m$，*不是*完全平方（中间项不匹配）。
  + 补全题：$x^2 + 12 x + 36 = (x + 6)^2$（中间 $12 = 2 dot 6$，所以末项 $= 6^2 = 36$）；$4 y^2 - 12 y + 9 = (2 y - 3)^2$（中间 $-12 y = -2 dot 2 y dot 3$，故空填 $12$）；$49 a^2 - 49 b^2 = (7 a + 7 b)(7 a - 7 b)$，前空 $49 a^2$、两个分式空填 $7 a$（也可填 $a^2 - 49 b^2 = (a + 7 b)(a - 7 b)$ 等价填法）。
