...
#blueprint[
  *怎样用这一节*
  ...
  下面 $5$ 道题每一题都明确标注了它所调用的*工具链*——即从本支的哪些章节出发。做每题之前，请先把标出的 `#secref` 过一遍，想一下“这里具体会用到那章的哪个动作”，再动笔。

  做完后对照 #secref("meta:algebra-summary-review") 里的参考答案。如果某题卡住，到 #secref("meta:al-repair-routes") 查“回补路径”。
]
