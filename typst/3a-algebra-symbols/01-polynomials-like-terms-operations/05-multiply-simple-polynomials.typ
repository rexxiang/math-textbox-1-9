...
#discovery[
  计算 $(x+5)(x+2)$，类比整数乘法 $15 times 12$——感觉也许"首项乘首项、尾项乘尾项"就够了：$x times x = x^2$，$5 times 2 = 10$，猜测答案是 $x^2 + 10$。

  试着推下去——

  取 $x = 3$：$(3 + 5)(3 + 2) = 8 times 5 = 40$。但 $x^2 + 10 = 9 + 10 = 19$——差了 $21$，明显不对。缺少的是 $x times 2 + 5 times x = 7x$；加上后 $x^2 + 7x + 10$，代入 $x = 3$ 得 $9 + 21 + 10 = 40$ ✓。

  只"首乘首、尾乘尾"会漏掉*中间的交叉项*——第一个括号的每一项必须与第二个括号的每一项各乘一次，否则必然漏项。多展开几道题，靠"凭感觉抄"必然有时多一项、有时少一项。
