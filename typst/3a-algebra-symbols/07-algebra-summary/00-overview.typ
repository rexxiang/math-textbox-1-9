...
#chapter-nav[
  ...
  *需要先会*：#secref("cb05-letters-represent-numbers")、#secref("ch:polynomials-like-terms-operations")、#secref("ch:distributive-identities-factorization")、#secref("ch:rational-expressions-operations-extraneous-roots")、#secref("ch:linear-equations-systems-modeling")、#secref("ch:quadratic-equations")、#secref("ch:linear-inequalities")。 \
