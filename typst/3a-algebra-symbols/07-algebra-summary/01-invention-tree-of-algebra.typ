...
#blueprint[
  *主干：从“字母代替数”到“方程与不等式”*
  ...
  + *代数式与同类项*（#secref("al01-like-terms-and-combine")、#secref("al01-add-subtract-polynomials")、#secref("al01-multiply-polynomials")）：字母与数的“加减乘”组合怎样化简？
...
#blueprint[
  *知识地图表：每一步因何被发明出来*
  ...
  #table(
    ...
    [代数式 / 同类项 #secref("al01-like-terms-and-combine")], [要像整数那样做“加减”，得先有“同类”概念], [去括号、合并成为基本动作],
